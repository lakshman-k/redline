...
$query=mysql_query("select * from job where jid='$id' ");
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Job Posting</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
  ...
  <div class="panel-body" style="float:left; width:40%;">
                        <form role="form" action="updatejob.php" method="post" >
                            <fieldset>
                            	<input type="hidden" name="jid" value="<?php echo $res['jid'] ?>">
                                <div class="form-group">
                                    <input class="form-control"  value="<?php echo $res['title'] ?>" name="title" type="text" required>
                                </div>
                                 <div class="form-group">
                                    <textarea cols="20" rows="10" class="form-control" name="desc" type="text" required><?php echo $res['desc'] ?></textarea>
                                </div>
                                <div class="form-group">
                                    <input class="form-control"  value="<?php echo $res['sal'] ?>"name="sal" type="text" required>
                                </div>
                                 <div class="form-group">
                                    <input class="form-control"  value="<?php echo $res['qual'] ?>"name="qual" type="text" required>
                                </div>
...
<table class="table table-bordered">
    ...
    <tbody>
       ...
       while($res=mysql_fetch_array($query))
       {
        ...
        <td>".$res['sal']."</td>
        <td>".$res['qual']."</td>
        <td><a class='btn btn-danger' href='delete.php?id=".$res['jid']."'>Delete</a> <a class='btn btn-info' href='postings.php'>add</a></td>
      </tr>";
  }
      ?>
    </tbody>
