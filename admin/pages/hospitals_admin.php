...
<!-- /.navbar-header -->
     ...
     <table class="table table-bordered" width: 100%>
    	<tr> 		
        		<th>User Name</th>  <th>Hospital Name</th>    <th>Address</th>  <th>City</th>  <th>Phone No</th>       
          </tr>
                <?php
					$query1="select * from hospital_details";
					$result1=mysqli_query($conn,$query1);
					 ...
					 ?>
         <tr>
        <td><?php echo $uname; ?></td> <td><?php echo $name; ?></td><td><?php echo $address; ?></td><td><?php echo $city; ?></td></td><td><?php echo $mobile; ?></td>
          </tr>
 <?php } ?>     
