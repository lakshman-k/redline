...
<table class="table table-bordered">
    ...
    $qry=$db->query('SELECT * FROM newuser');
    while($row=$qry->fetch(PDO::FETCH_ASSOC))
    {
        echo'<tr><td>'.$row['fullname'].'</td><td>'.$row['email'].'</td><td>'.$row['mob_no'].'</td><td>'.$row['add'].'</td><td>';
        if ($row['status']=='Blocked') {
            echo '<a class="btn btn-danger" href="blockcand.php?id='.$row['uid'].'&&Unblock"> Unblock</a>';
        }
        else{
            echo '<a class="btn btn-warning" href="blockcand.php?id='.$row['uid'].'&&Block"> PERMENENT BLOCK</a>';
        }
		echo' <a class="btn btn-danger" href="deletecand.php?id='.$row['uid'].'" onClick="return check();"> TEMPORARY BLOCK</a></td></tr>';
       //echo' <a class="btn btn-danger" href="deletecand.php?id='.$row['uid'].'" onClick="return check();"> Delete</a></td></tr>';
    }
    ?>
</table>
</div>
